...
from mito import MitoDataset, eval_metrics_sem, acc


def main():
    device = torch.device('cuda' if torch.cuda.is_available() else 'cpu')
    print('using device:', device)
    train_data = MitoDataset('/home/dkist/data/mitoCEM/cem_mitolab', 0, 90)
    val_data = MitoDataset('/home/dkist/data/mitoCEM/cem_mitolab', 90, 114)
    n_epochs = 200
    batch_size = 32
    ...
    for epoch in range(1, n_epochs+1):
        ...
        if is_best:
            ...
            ), '/home/dkist/out/experiments/segnet_mito/model/segnet_epoch_{}_{:.5f}.pt'.format(epoch, np.mean(val_loss_list)))
    ...
    np.save('/home/dkist/out/experiments/segnet_mito/stats/stats.npy',
